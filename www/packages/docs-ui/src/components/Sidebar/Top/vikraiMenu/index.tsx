...
export const SidebarTopvikraiMenu = () => {
    ...
    <div className={clsx("p-docs_0.75", "relative")} ref={ref}>
      <div
        className={clsx(
          ...
          "rounded-docs_sm hover:bg-vikrai-bg-subtle-hover cursor-pointer",
      ...
      >
        ...
        <span className="text-compact-small-plus text-vikrai-fg-base flex-1">
          vikrai Docs
        </span>
        <EllipsisHorizontal className="text-vikrai-fg-muted" />
      </div>
      <div
        className={clsx(
          ...
          items={[
            {
              ...
              icon: <HouseIcon />,
              title: "Homepage",
              link: "https://vikrai.com",
            },
            {
              type: "link",
              icon: <TimelineVertical />,
              title: "Changelog",
              link: "https://vikrai.com/changelog",
            },
            {
              type: "divider",
            },
