 ...
 * description: Cancel an order transfer that the logged-in customer previously requested using the [Request Order Transfer](https://docs.vikrai.com/api/store#orders_postordersidtransferrequest) API route.
