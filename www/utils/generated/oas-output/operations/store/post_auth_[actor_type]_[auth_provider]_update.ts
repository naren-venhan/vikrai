 ...
 * description: Reset a customer's password using a reset-password token generated with the [Generate Reset Password Token API route](https://docs.vikrai.com/api/store#auth_postactor_typeauth_providerresetpassword). You pass the token as a bearer token in the request's Authorization header.
 * externalDocs:
 *   url: https://docs.vikrai.com/v2/resources/storefront-development/customers/reset-password#2-reset-password-page
