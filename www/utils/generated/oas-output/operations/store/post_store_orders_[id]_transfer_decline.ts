 ...
 * description: Decline an order transfer previously requested, typically by the admin user using the [Request Order Transfer Admin API route](https://docs.vikrai.com/api/admin#orders_postordersidtransferrequest).
