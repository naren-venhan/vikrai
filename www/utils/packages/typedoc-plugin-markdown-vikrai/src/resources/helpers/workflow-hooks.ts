...
export default function (theme: MarkdownTheme) {
  Handlebars.registerHelper(
    ...
    function (this: SignatureReflection): string {
      ...
      let str = `${Handlebars.helpers.titleLevel()} Hooks\n\nHooks allow you to inject custom functionalities into the workflow. You'll receive data from the workflow, as well as additional data sent through an HTTP request.\n\nLearn more about [Hooks](https://docs.vikrai.com/learn/fundamentals/workflows/workflow-hooks) and [Additional Data](https://docs.vikrai.com/learn/fundamentals/api-routes/additional-data).\n\n`
