...
/**
 * Docblock generate for vikrai-react hooks. Since hooks are essentially functions,
 * it extends the {@link FunctionKindGenerator} class.
 */
class vikraiReactHooksKindGenerator extends FunctionKindGenerator {
  public name = "vikrai-react"
  /**
  ...
  /**
   * Retrieves the docblock of the vikrai-react hook or mutation.
   *
...
export default vikraiReactHooksKindGenerator
