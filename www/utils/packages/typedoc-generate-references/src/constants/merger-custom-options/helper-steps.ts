...
const helperStepsOptions: FormattingOptionsType = {
  ...
  "^modules/helper_steps/page\\.mdx": {
    reflectionDescription:
      "This section of the documentation provides a reference to utility steps that you can use in your workflows. These steps are imported from the `@vikrai/vikrai/core-flows` package.",
    reflectionGroups: {
      Namespaces: false,
      Enumerations: false,
      Classes: false,
  ...
  "^helper_steps/functions": {
    reflectionDescription:
      "This documentation provides a reference to the `{{alias}}` step. It belongs to the `@vikrai/vikrai/core-flows` package.",
    frontmatterData: {
