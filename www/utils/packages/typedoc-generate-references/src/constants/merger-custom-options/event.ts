...
In your workflow's step, you can resolve the Event Module's service from the vikrai container:
...
This will resolve the service of the configured Event Module, which is the [Local Event Module](https://docs.vikrai.com/resources/infrastructure-modules/event/local) by default.
