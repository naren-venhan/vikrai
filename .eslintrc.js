  ...
  overrides: [
    {
      ...
      parserOptions: {
        project: [
          ...
          "./packages/cli/create-vikrai-app/tsconfig.json",
          "./packages/cli/vikrai-cli/tsconfig.spec.json",
          "./packages/cli/oas/vikrai-oas-cli/tsconfig.spec.json",
          ...
          "./packages/core/vikrai-test-utils/tsconfig.json",
