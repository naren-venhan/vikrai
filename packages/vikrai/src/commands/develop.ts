...
import { Store } from "@vikrai/telemetry"
import { EOL } from "os"
import path from "path"

import { logger } from "@vikrai/framework/logger"
import { vikrai_CLI_PATH } from "@vikrai/framework"
...
export default async function ({ types, directory }) {
  ...
  /**
   * Re-constructing the path to vikrai CLI to execute the
   * start command.
   */
