...
import { vikraiResponse } from "@vikrai/framework/http"
import { HttpTypes, QueryContextType } from "@vikrai/framework/types"
import {
...
export const GET = async (
  ...
  res: vikraiResponse<HttpTypes.StoreProductListResponse>
) => {
