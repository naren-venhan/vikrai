import { vikraiStoreRequest, refetchEntity } from "@vikrai/framework/http"
import {
  HttpTypes,
  ItemTaxLineDTO,
  vikraiContainer,
...
import { calculateAmountsWithTax, Modules } from "@vikrai/framework/utils"

export type RequestWithContext<
  Body,
  QueryFields = Record<string, unknown>
> = vikraiStoreRequest<Body, QueryFields> & {
  taxContext: {
