import { beginClaimOrderWorkflow } from "@vikrai/core-flows"
...
export const GET = async (
  req: AuthenticatedvikraiRequest<HttpTypes.AdminClaimListParams>,
  res: vikraiResponse<HttpTypes.AdminClaimListResponse>
) => {
...
export const POST = async (
  req: AuthenticatedvikraiRequest<AdminPostOrderClaimsReqSchemaType>,
  res: vikraiResponse<HttpTypes.AdminClaimOrderResponse>
) => {
  const input = {
    ...req.validatedBody,
