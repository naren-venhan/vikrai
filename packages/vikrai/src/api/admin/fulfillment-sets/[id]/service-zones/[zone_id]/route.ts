...
export const GET = async (
  ...
  res: vikraiResponse<AdminServiceZoneResponse>
) => {
...
export const POST = async (
  req: vikraiRequest<AdminUpdateFulfillmentSetServiceZonesType>,
  res: vikraiResponse<AdminFulfillmentSetResponse>
) => {
...
export const DELETE = async (
  req: AuthenticatedvikraiRequest,
  res: vikraiResponse<HttpTypes.AdminServiceZoneDeleteResponse>
) => {
