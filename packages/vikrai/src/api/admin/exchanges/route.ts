import { beginExchangeOrderWorkflow } from "@vikrai/core-flows"
...
export const GET = async (
  req: AuthenticatedvikraiRequest<HttpTypes.AdminExchangeListParams>,
  res: vikraiResponse<HttpTypes.AdminExchangeListResponse>
) => {
...
export const POST = async (
  req: AuthenticatedvikraiRequest<AdminPostOrderExchangesReqSchemaType>,
  res: vikraiResponse<HttpTypes.AdminExchangeOrderResponse>
) => {
  const input = {
    ...req.validatedBody,
