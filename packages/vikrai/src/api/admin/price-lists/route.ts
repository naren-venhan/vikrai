import { createPriceListsWorkflow } from "@vikrai/core-flows"
import {
...
export const GET = async (
  req: AuthenticatedvikraiRequest<HttpTypes.AdminPriceListListParams>,
  res: vikraiResponse<HttpTypes.AdminPriceListListResponse>
) => {
...
export const POST = async (
  req: AuthenticatedvikraiRequest<AdminCreatePriceListType>,
