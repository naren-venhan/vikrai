...
export const GET = async (
  req: vikraiRequest<HttpTypes.AdminOrderFilters>,
  res: vikraiResponse<HttpTypes.AdminDraftOrderListResponse>
) => {
  const variables = {
    filters: {
...
export const POST = async (
  req: AuthenticatedvikraiRequest<AdminCreateDraftOrderType & AdditionalData>,
  res: vikraiResponse<HttpTypes.AdminDraftOrderResponse>
) => {
