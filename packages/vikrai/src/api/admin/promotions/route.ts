import { createPromotionsWorkflow } from "@vikrai/core-flows"
import {
...
export const GET = async (
  req: AuthenticatedvikraiRequest<HttpTypes.AdminGetPromotionsParams>,
  res: vikraiResponse<HttpTypes.AdminPromotionListResponse>
) => {
