import { beginReturnOrderWorkflow } from "@vikrai/core-flows"
...
export const GET = async (
  ...
  res: vikraiResponse<HttpTypes.AdminReturnsResponse>
) => {
...
export const POST = async (
  req: AuthenticatedvikraiRequest<AdminPostReturnsReqSchemaType>,
