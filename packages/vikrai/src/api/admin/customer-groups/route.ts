...
import { createCustomerGroupsWorkflow } from "@vikrai/core-flows"
import {
...
export const GET = async (
  req: AuthenticatedvikraiRequest<HttpTypes.AdminGetCustomerGroupsParams>,
  res: vikraiResponse<HttpTypes.AdminCustomerGroupListResponse>
) => {
...
export const POST = async (
  req: AuthenticatedvikraiRequest<AdminCreateCustomerGroupType>,
