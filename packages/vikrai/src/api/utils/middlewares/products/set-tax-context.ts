import { TaxCalculationContext } from "@vikrai/framework/types"
...
export function setTaxContext() {
  return async (req: AuthenticatedvikraiRequest, _, next: NextFunction) => {
    ...
    try {
      ...
      // TODO: Allow passing a context typings param to AuthenticatedvikraiRequest
...
const getTaxInclusivityInfo = async (req: vikraiRequest) => {
...
const getTaxLinesContext = async (req: vikraiRequest) => {
