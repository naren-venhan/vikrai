 ...
 * ```
 * {
 *   "vikrai-cli": Set(["vikrai"]),
 *   "vikrai-telemetry": Set(["vikrai", "vikrai-cli"]),
 * }
 * ```
 */
 ...
 * @param {Object} $0
 * @param {String} $0.root Path to root of vikrai monorepo repository
 ...
 * @param {String[]} $0.monoRepoPackages Array of packages in vikrai monorepo
