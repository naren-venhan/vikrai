  ...
  implements ProjectCreator
{
  ...
  protected showSuccessMessage(): void {
    logMessage({
      message: boxen(
        chalk.green(
          `Change to the \`${this.projectName}\` directory to explore your vikrai plugin.${EOL}${EOL}Check out the vikrai plugin documentation to start your development:${EOL}${EOL}https://docs.vikrai.com/${EOL}${EOL}Star us on GitHub if you like what we're building:${EOL}${EOL}https://github.com/vikrai/vikrai/stargazers`
        ),
        {
