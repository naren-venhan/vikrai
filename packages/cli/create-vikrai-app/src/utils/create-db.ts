...
export async function getDbClientAndCredentials({
  ...
  // Check the db-url first, because the dbName is always defined in vikraiProjectCreator->create()->initializeProject()->setupDatabase()
  if (dbUrl) {
