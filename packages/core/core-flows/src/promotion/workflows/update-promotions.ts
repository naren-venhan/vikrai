...
import { isString } from "@vikrai/framework/utils"
import {
  createHook,
  createWorkflow,
  transform,
...
/**
 * This workflow updates one or more promotions. It's used by the [Update Promotion Admin API Route](https://docs.vikrai.com/api/admin#promotions_postpromotionsid).
 *
