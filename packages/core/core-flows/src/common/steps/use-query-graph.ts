...
import { createStep, StepFunction, StepResponse } from "@vikrai/workflows-sdk"
 ...
 *
 * Learn more in the [Query documentation](https://docs.vikrai.com/learn/fundamentals/module-links/query).
 * 
 * @example
