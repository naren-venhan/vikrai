...
/**
 * This workflow creates one or more product options. It's used by the [Create Product Option Admin API Route](https://docs.vikrai.com/api/admin#products_postproductsidoptions).
 * 
