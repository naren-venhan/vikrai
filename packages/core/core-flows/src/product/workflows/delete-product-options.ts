import { Modules, ProductOptionWorkflowEvents } from "@vikrai/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Delete Product Option Admin API Route](https://docs.vikrai.com/api/admin#products_deleteproductsidoptionsoption_id).
 *
