...
import { ProductTypeWorkflowEvents } from "@vikrai/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Update Product Type Admin API Route](https://docs.vikrai.com/api/admin#product-types_postproducttypesid).
 * 
