import { CreateTaxRateRuleDTO, TaxRateRuleDTO } from "@vikrai/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Create Tax Rules for Rates Admin API Route](https://docs.vikrai.com/api/admin#tax-rates_posttaxratesidrules).
 * 
