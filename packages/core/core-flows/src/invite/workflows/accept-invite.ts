import { InviteWorkflow, UserDTO } from "@vikrai/framework/types"
 ...
 * [Accept Invite Admin API Route](https://docs.vikrai.com/api/admin#invites_postinvitesaccept).
 * 
 ...
 * using the [Retrieve Registration JWT Token API Route](https://docs.vikrai.com/api/admin#auth_postactor_typeauth_provider_register).
 * 
