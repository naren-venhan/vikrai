 ...
 * [Refresh Invite Token Admin API Route](https://docs.vikrai.com/api/admin#invites_postinvitesidresend).
 * 
 * This workflow is useful to trigger resending invite tokens. It emits the `invite.resent` event,
 * which you can listen to in a [Subscriber](https://docs.vikrai.com/learn/fundamentals/events-and-subscribers).
 * 
