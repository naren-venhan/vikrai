 ...
 * It's used by the [Add Inbound Shipping Admin API Route](https://docs.vikrai.com/api/admin#claims_postclaimsidinboundshippingmethod),
 * and the [Add Outbound Shipping Admin API Route](https://docs.vikrai.com/api/admin#claims_postclaimsidoutboundshippingmethod).
 *
