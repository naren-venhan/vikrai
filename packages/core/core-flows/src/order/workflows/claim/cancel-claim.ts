 ...
 * :::note
 *
 * You can retrieve an order claim's details using [Query](https://docs.vikrai.com/learn/fundamentals/module-links/query),
 ...
 * [Cancel Claim API Route](https://docs.vikrai.com/api/admin#claims_postclaimsidcancel).
 *
