 ...
 * [Get an Order Admin API Route](https://docs.vikrai.com/api/admin#orders_getordersid), and
 * [Get an Order Store API Route](https://docs.vikrai.com/api/store#orders_getordersid).
 * 
