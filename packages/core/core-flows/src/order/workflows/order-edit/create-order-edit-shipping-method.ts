 ...
 * [Add Shipping Method API Route](https://docs.vikrai.com/api/admin#order-edits_postordereditsidshippingmethod).
 *
 ...
 * 
 * ```ts
 * import { createOrderEditShippingMethodWorkflow } from "@vikrai/vikrai/core-flows";
