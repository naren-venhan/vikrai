...
export class Region {
   ...
   * [Create Region](https://docs.vikrai.com/api/admin#regions_postregions)
   * API route.
   * 
   ...
   * [Update Region](https://docs.vikrai.com/api/admin#regions_postregionsid)
   * API route.
   * 
   ...
   * [List Regions](https://docs.vikrai.com/api/admin#regions_getregions)
   * API route.
   * 
   ...
   * [Get Region](https://docs.vikrai.com/api/admin#regions_getregionsid)
   * API route.
   * 
   ...
   * [Delete Region](https://docs.vikrai.com/api/admin#regions_deleteregionsid)
   * API route.
   * 
