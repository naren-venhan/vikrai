...
export class InventoryItem {
   ...
   * [Create Inventory Item](https://docs.vikrai.com/api/admin#inventory-items_postinventoryitems)
   * API route.
   *
   ...
   * [Update Inventory Item](https://docs.vikrai.com/api/admin#inventory-items_postinventoryitemsid)
   * API route.
   *
   ...
   * [List Inventory Items](https://docs.vikrai.com/api/admin#inventory-items_getinventoryitems)
   * API route.
   *
   ...
   * [Get Inventory Item](https://docs.vikrai.com/api/admin#inventory-items_getinventoryitemsid) API route.
   *
   * @param id - The inventory item's ID.
   * @param query - Configure the fields to retrieve in the inventory item.
   * @param headers - Headers to pass in the request
   ...
   * [Delete Inventory Item](https://docs.vikrai.com/api/admin#inventory-items_deleteinventoryitemsid)
   * API route.
   *
   * @param id - The inventory item's ID.
   * @param headers - Headers to pass in the request
   ...
   * It sends a request to the [List Inventory Items](https://docs.vikrai.com/api/admin#inventory-items_getinventoryitems)
   * API route.
   *
   * @param id - The inventory item's ID.
   * @param query - Filters and pagination configurations.
   ...
   * [Update Inventory Level](https://docs.vikrai.com/api/admin#inventory-items_postinventoryitemsidlocationlevelslocation_id)
   * API route.
   *
   * @param id - The inventory item's ID.
   ...
   *
   * This method sends a request to the
   * [Remove Inventory Level](https://docs.vikrai.com/api/admin#inventory-items_deleteinventoryitemsidlocationlevelslocation_id)
   * API route.
   *
   * @param id - The inventory item's ID.
   * @param locationId - The stock location's ID.
   ...
   * [Manage Inventory Levels](https://docs.vikrai.com/api/admin#inventory-items_postinventoryitemsidlocationlevelsbatch)
   * API route.
   *
