...
export class Return {
   ...
   * [List Returns](https://docs.vikrai.com/api/admin#returns_getreturns)
   * API route.
   * 
   ...
   * [Get Return](https://docs.vikrai.com/api/admin#returns_getreturnsid)
   * API route.
   * 
   ...
   * [Create Return](https://docs.vikrai.com/api/admin#returns_postreturns)
   * API route.
   * 
   ...
   * [Cancel Return](https://docs.vikrai.com/api/admin#returns_postreturnsidcancel)
   * API route.
   * 
   ...
   * [Cancel Return Request](https://docs.vikrai.com/api/admin#returns_deletereturnsidrequest)
   * API route.
   * 
   * @param id - The ID of the return to cancel.
   * @param query - Configure the fields and relations to retrieve in the return.
   ...
   * [Add Return Item](https://docs.vikrai.com/api/admin#returns_postreturnsidrequestitems)
   * API route.
   * 
   ...
   * [Update Requested Return Item](https://docs.vikrai.com/api/admin#returns_postreturnsidrequestitemsaction_id)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Remove Item from Return](https://docs.vikrai.com/api/admin#returns_deletereturnsidrequestitemsaction_id)
   * API route.
   * 
   ...
   * [Add Shipping Method to Return](https://docs.vikrai.com/api/admin#returns_postreturnsidshippingmethod)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Update Shipping Method in Return](https://docs.vikrai.com/api/admin#returns_postreturnsidshippingmethodaction_id)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Remove Shipping Method from Return](https://docs.vikrai.com/api/admin#returns_deletereturnsidshippingmethodaction_id)
   * API route.
   * 
   ...
   * [Update Return](https://docs.vikrai.com/api/admin#returns_postreturnsid)
   * API route.
   * 
   ...
   * [Confirm Return Receival](https://docs.vikrai.com/api/admin#returns_postreturnsidreceiveconfirm)
   * API route.
   * 
   * This method sends a request to the
   * [Confirm Return Request](https://docs.vikrai.com/api/admin#returns_postreturnsidrequest)
   * API route.
   * 
   ...
   * [Start Return Receival](https://docs.vikrai.com/api/admin#returns_postreturnsidreceive)
   * API route.
   * 
   ...
   * [Add Received Items](https://docs.vikrai.com/api/admin#returns_postreturnsidreceiveitems)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Update Received Item](https://docs.vikrai.com/api/admin#returns_postreturnsidreceiveitemsaction_id)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Remove Received Item](https://docs.vikrai.com/api/admin#returns_deletereturnsidreceiveitemsaction_id)
   * API route.
   * 
   ...
   * 
   * The method sends a request to the
   * [Add Damaged Items](https://docs.vikrai.com/api/admin#returns_postreturnsiddismissitems)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Update Damaged Item](https://docs.vikrai.com/api/admin#returns_postreturnsiddismissitemsaction_id)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Remove Damaged Item](https://docs.vikrai.com/api/admin#returns_deletereturnsiddismissitemsaction_id)
   * API route.
   * 
   ...
   * [Cancel Return Receival](https://docs.vikrai.com/api/admin#returns_deletereturnsidreceive)
   * API route.
   * 
