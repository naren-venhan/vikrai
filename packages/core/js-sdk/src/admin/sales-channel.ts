...
export class SalesChannel {
   ...
   * [Create Sales Channel](https://docs.vikrai.com/api/admin#sales-channels_postsaleschannels)
   * API route.
   * 
   ...
   * [Update Sales Channel](https://docs.vikrai.com/api/admin#sales-channels_postsaleschannelsid)
   * API route.
   * 
   ...
   * [Delete Sales Channel](https://docs.vikrai.com/api/admin#sales-channels_deletesaleschannelsid)
   * API route.
   * 
   ...
   * [Retrieve Sales Channel](https://docs.vikrai.com/api/admin#sales-channels_getsaleschannelsid)
   * API route.
   * 
   ...
   * [List Sales Channels](https://docs.vikrai.com/api/admin#sales-channels_getsaleschannels)
   * API route.
   * 
   ...
   * [Manage Products in Sales Channel](https://docs.vikrai.com/api/admin#sales-channels_postsaleschannelsidproducts)
   * API route.
   * 
