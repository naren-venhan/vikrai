...
export class ReturnReason {
   ...
   * [List Return Reasons](https://docs.vikrai.com/api/admin#return-reasons_returnreason_schema)
   * API route.
   * 
   ...
   * [Get Return Reason](https://docs.vikrai.com/api/admin#return-reasons_getreturnreasonsid)
   * API route.
   * 
   ...
   * [Create Return Reason](https://docs.vikrai.com/api/admin#return-reasons_postreturnreasons)
   * API route.
   * 
   ...
   * [Update Return Reason](https://docs.vikrai.com/api/admin#return-reasons_postreturnreasonsid)
   * API route.
   * 
   * @param id - The return reason's ID.
   ...
   * [Delete Return Reason](https://docs.vikrai.com/api/admin#return-reasons_deletereturnreasonsid)
   * API route.
   * 
   * @param id - The return reason's ID.
