...
export class ApiKey {
   ...
   * [List API Keys](https://docs.vikrai.com/api/admin#api-keys_getapikeys) API route.
   * 
  ...
  /**
   * This method creates an API key. It sends a request to the [Create API Key](https://docs.vikrai.com/api/admin#api-keys_postapikeys)
   * API route.
   * 
   ...
   * [Revoke API Key](https://docs.vikrai.com/api/admin#api-keys_postapikeysidrevoke) API route.
   * 
   ...
   * [Get API key](https://docs.vikrai.com/api/admin#api-keys_getapikeysid) API route.
   * 
   * @param id - The API key's ID.
   * @param headers - Headers to pass in the request.
   * @returns The API key's details.
   ...
   * [Update API Key](https://docs.vikrai.com/api/admin#api-keys_postapikeysid) API route.
   * 
   * @param id - The API key's ID.
   ...
   * [Delete API Key](https://docs.vikrai.com/api/admin#api-keys_deleteapikeysid) API route.
   * 
   * @param id - The API key's ID.
   * @param headers - Headers to pass in the request.
   ...
   * or remove associations. It sends a request to the [Manage Sales Channels](https://docs.vikrai.com/api/admin#api-keys_postapikeysidsaleschannels)
   * API route.
   * 
   * @param id - The API key's ID.
