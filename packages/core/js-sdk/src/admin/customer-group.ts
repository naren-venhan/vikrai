...
export class CustomerGroup {
   ...
   * [Get Customer Group](https://docs.vikrai.com/api/admin#customer-groups_getcustomergroupsid) API route.
   * 
   ...
   * [List Customer Groups](https://docs.vikrai.com/api/admin#customer-groups_getcustomergroups)
   * API route.
   * 
   ...
   * [Create Customer Group](https://docs.vikrai.com/api/admin#customer-groups_postcustomergroups)
   * API route.
   * 
   ...
   * [Update Customer](https://docs.vikrai.com/api/admin#customer-groups_postcustomergroupsid)
   * API route.
   * 
   * @param id - The customer group's ID.
   ...
   * [Delete Customer Group](https://docs.vikrai.com/api/admin#customer-groups_deletecustomergroupsid)
   * API route.
   * 
   * @param id - The customer group's ID.
   * @param headers - Headers to pass in the request
   ...
   * It sends a request to the [Manage Customers](https://docs.vikrai.com/api/admin#customer-groups_postcustomergroupsidcustomers)
   * API route.
   * 
