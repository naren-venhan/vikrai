...
export class OrderEdit {
   ...
   * [Create Order Edit](https://docs.vikrai.com/api/admin#order-edits_postorderedits)
   * API route.
   * 
   ...
   * [Request Order Edit](https://docs.vikrai.com/api/admin#order-edits_postordereditsidrequest)
   * API route.
   * 
   ...
   * to the [Confirm Order Edit](https://docs.vikrai.com/api/admin#order-edits_postordereditsidconfirm)
   * API route.
   * 
   * @param id - The order edit's ID.
   * @param query - Configure the fields to retrieve in the order preview.
   ...
   * [Cancel Order Edit](https://docs.vikrai.com/api/admin#order-edits_deleteordereditsid)
   * API route.
   * 
   * @param id - The order edit's ID.
   ...
   * 
   * The method sends a request to the [Add Items](https://docs.vikrai.com/api/admin#order-edits_postordereditsiditems)
   * API route.
   * 
   * @param id - The order edit's ID.
   ...
   * [Update Item Quantity](https://docs.vikrai.com/api/admin#order-edits_postordereditsiditemsitemitem_id)
   * API route.
   * 
   * @param id - The order edit's ID.
   ...
   * 
   * It sends a request
   * to the [Update Item](https://docs.vikrai.com/api/admin#order-edits_postordereditsiditemsaction_id)
   * API route.
   * 
   * @param id - The order edit's ID.
