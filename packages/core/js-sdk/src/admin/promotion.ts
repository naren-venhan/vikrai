...
export class Promotion {
   ...
   * [Retrieve Promotion](https://docs.vikrai.com/api/admin#promotions_getpromotionsid)
   * API route.
   * 
   ...
   * [List Promotions](https://docs.vikrai.com/api/admin#promotions_getpromotions)
   * API route.
   * 
   ...
   * [Create Promotion](https://docs.vikrai.com/api/admin#promotions_postpromotions)
   * API route.
   * 
   ...
   * [Update Promotion](https://docs.vikrai.com/api/admin#promotions_postpromotionsid)
   * API route.
   * 
   * @param id - The promotion's ID.
   ...
   * [Delete Promotion](https://docs.vikrai.com/api/admin#promotions_deletepromotionsid)
   * API route.
   * 
   * @param id - The promotion's ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Manage Promotion's Rules API Route](https://docs.vikrai.com/api/admin#promotions_postpromotionsidrulesbatch).
   * - If you set the `ruleType` to `buy-rules`, the method sends a request to the 
   * [Manage Promotion's Buy Rules API Route](https://docs.vikrai.com/api/admin#promotions_postpromotionsidbuyrulesbatch).
   * - If you set the `ruleType` to `target-rules`, the method sends a request to the 
   * [Manage Promotion's Target Rules API Route](https://docs.vikrai.com/api/admin#promotions_postpromotionsidtargetrulesbatch).
   * 
   * @param id - The promotion's ID.
   ...
   * [List Rules of a Promotion API Route](https://docs.vikrai.com/api/admin#promotions_getpromotionsidrule_type)
   * 
   * @param id - The promotion's ID.
   ...
   * 
   * This method sends a request to the
   * [List Rule Attribute Options API Route](https://docs.vikrai.com/api/admin#promotions_getpromotionsruleattributeoptionsrule_type)
   * 
   ...
   *  
   * This method sends a request to the
   * [List Rule Values API Route](https://docs.vikrai.com/api/admin#promotions_getpromotionsrulevalueoptionsrule_typerule_attribute_id)
   * 
