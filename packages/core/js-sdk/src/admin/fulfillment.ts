...
export class Fulfillment {
   ...
   * [Create Fulfillment](https://docs.vikrai.com/api/admin#fulfillments_postfulfillments)
   * API route.
   * 
   ...
   * [Cancel Fulfillment](https://docs.vikrai.com/api/admin#fulfillments_postfulfillmentsidcancel)
   * API route.
   * 
   ...
   * [Create Shipment](https://docs.vikrai.com/api/admin#fulfillments_postfulfillmentsidshipment)
   * API route.
   * 
   * @param id - The fulfillment's ID.
