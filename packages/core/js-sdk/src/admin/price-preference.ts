...
export class PricePreference {
   ...
   * [Get Price Preference](https://docs.vikrai.com/api/admin#price-preferences_getpricepreferencesid)
   * API route.
   * 
   ...
   * [List Price Preferences](https://docs.vikrai.com/api/admin#price-preferences_getpricepreferences) API route.
   * 
   ...
   * [Create Price Preference](https://docs.vikrai.com/api/admin#price-preferences_postpricepreferences)
   * API route.
   * 
   ...
   * [Update Price Preference](https://docs.vikrai.com/api/admin#price-preferences_postpricepreferencesid)
   * API route.
   * 
   * @param id - The price preference's ID.
   ...
   * [Delete Price Preference](https://docs.vikrai.com/api/admin#price-preferences_deletepricepreferencesid)
   * API route.
   * 
   * @param id - The price preference's ID.
   * @param headers - Headers to pass in the request
