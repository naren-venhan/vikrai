...
export class Notification {
   ...
   * [Get Notification](https://docs.vikrai.com/api/admin#notifications_getnotificationsid)
   * API route.
   * 
   ...
   * [List Notifications](https://docs.vikrai.com/api/admin#notifications_getnotifications)
   * API route.
   * 
