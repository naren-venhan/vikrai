...
export class FulfillmentProvider {
   ...
   * [List Fulfillment Providers](https://docs.vikrai.com/api/admin#fulfillment-providers_getfulfillmentproviders)
   * API route.
   *
   ...
   * [List Fulfillment Options](https://docs.vikrai.com/api/admin#fulfillment-providers_getfulfillmentprovidersidoptions)
   * API route.
   *
