...
export class Store {
   ...
   * [Get Store](https://docs.vikrai.com/api/admin#stores_getstoresid)
   * API route.
   * 
   ...
   * [List Stores](https://docs.vikrai.com/api/admin#stores_getstores)
   * API route.
   * 
   ...
   * [Update Store](https://docs.vikrai.com/api/admin#stores_poststoresid)
   * API route.
   * 
