...
export class Campaign {
   ...
   * [Get Campaign](https://docs.vikrai.com/api/admin#campaigns_getcampaignsid) API route.
   * 
   ...
   * [List Campaigns](https://docs.vikrai.com/api/admin#campaigns_getcampaigns) API route.
   * 
   ...
   * [Create Campaign](https://docs.vikrai.com/api/admin#campaigns_postcampaigns) API route.
   * 
   ...
   * [Update Campaign](https://docs.vikrai.com/api/admin#campaigns_postcampaignsid) API route.
   * 
   * @param id - The campaign's ID.
   ...
   * [Delete Campaign](https://docs.vikrai.com/api/admin#campaigns_deletecampaignsid) API route.
   * 
   * @param id - The campaign's ID.
   * @param headers - Headers to pass in the request
   ...
   * It sends a request to the [Manage Promotions](https://docs.vikrai.com/api/admin#campaigns_postcampaignsidpromotions)
   * API route.
   * 
   * @param id - The campaign's ID.
