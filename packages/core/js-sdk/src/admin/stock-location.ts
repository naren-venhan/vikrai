...
export class StockLocation {
   ...
   * [Create Stock Location](https://docs.vikrai.com/api/admin#stock-locations_poststocklocations)
   * API route.
   * 
   ...
   * [Update Stock Location](https://docs.vikrai.com/api/admin#stock-locations_poststocklocationsid)
   * API route.
   * 
   ...
   * [Delete Stock Location](https://docs.vikrai.com/api/admin#stock-locations_deletestocklocationsid)
   * API route.
   * 
   ...
   * [Get Stock Location](https://docs.vikrai.com/api/admin#stock-locations_getstocklocationsid)
   * API route.
   * 
   ...
   * [List Stock Locations](https://docs.vikrai.com/api/admin#stock-locations_getstocklocations)
   * API route.
   * 
   ...
   * [Manage Stock Location Sales Channels](https://docs.vikrai.com/api/admin#stock-locations_poststocklocationsidsaleschannels)
   * API route.
   * 
   ...
   * [Add Fulfillment Set to Stock Location](https://docs.vikrai.com/api/admin#stock-locations_poststocklocationsidfulfillmentsets)
   * API route.
   * 
   ...
   * [Manage Fulfillment Providers of Stock Location](https://docs.vikrai.com/api/admin#stock-locations_poststocklocationsidfulfillmentproviders)
   * API route.
   * 
