...
export class PriceList {
   ...
   * [Get Price List](https://docs.vikrai.com/v2/api/admin#price-lists_getpricelistsid)
   * API route.
   * 
   ...
   * ```
   * 
   * Learn more about the `fields` property in the [API reference](https://docs.vikrai.com/v2/api/store#select-fields-and-relations).
   */
  async retrieve(
    id: string,
   ...
   * [List Price Lists](https://docs.vikrai.com/v2/api/admin#price-lists_getpricelists) API route.
   * 
   ...
   * [Create Price List](https://docs.vikrai.com/v2/api/admin#price-lists_postpricelists)
   * API route.
   * 
   ...
   * [Update Price List](https://docs.vikrai.com/v2/api/admin#price-lists_postpricelistsid)
   * API route.
   * 
   * @param id - The price list's ID.
   ...
   * [Delete Price List](https://docs.vikrai.com/v2/api/admin#price-lists_deletepricelistsid)
   * API route.
   * 
   * @param id - The price list's ID.
   * @param headers - Headers to pass in the request
   ...
   * It sends a request to the [Manage Prices](https://docs.vikrai.com/v2/api/admin#price-lists_postpricelistsidpricesbatch)
   * API route.
   * 
   * @param id - The price list's ID.
   ...
   * [Remove Product](https://docs.vikrai.com/v2/api/admin#price-lists_postpricelistsidproducts)
   * API route.
   * 
   * @param id - The price list's ID.
