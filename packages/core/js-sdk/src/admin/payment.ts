...
export class Payment {
   ...
   * [List Payments](https://docs.vikrai.com/api/admin#payments_getpayments) API route.
   * 
   ...
   * [List Payment Providers](https://docs.vikrai.com/api/admin#payments_getpaymentspaymentproviders) API route.
   * 
   * @param query - Filters and pagination configurations.
   * @param headers - Headers to pass in the request.
   ...
   * [Get Payment](https://docs.vikrai.com/api/admin#payments_getpaymentsid)
   * API route.
   * 
   ...
   * [Capture Payment](https://docs.vikrai.com/api/admin#payments_postpaymentsidcapture) API route.
   * 
   ...
   * [Refund Payment](https://docs.vikrai.com/api/admin#payments_postpaymentsidrefund) API route.
   * 
