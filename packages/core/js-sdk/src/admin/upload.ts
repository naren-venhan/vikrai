...
export class Upload {
   ...
   * [Upload Files](https://docs.vikrai.com/api/admin#uploads_postuploads)
   * API route.
   * 
   ...
   * [Get File](https://docs.vikrai.com/api/admin#uploads_getuploadsid)
   * API route.
   * 
   ...
   * [Delete File](https://docs.vikrai.com/api/admin#uploads_deleteuploadsid)
   * API route.
   * 
