...
export class Claim {
   ...
   * [List Claims](https://docs.vikrai.com/api/admin#claims_getclaims) API route.
   * 
   ...
   * [Get Claim](https://docs.vikrai.com/api/admin#claims_getclaimsid) API route.
   * 
   ...
   * [Create Claim](https://docs.vikrai.com/api/admin#claims_postclaims) API route.
   * 
   ...
   * [Cancel Claim](https://docs.vikrai.com/api/admin#claims_postclaimsidcancel) API route.
   * 
   * @param id - The claim's ID.
   * @param query - Configure the fields to retrieve in the claim.
   * @param headers - Headers to pass in the request
   ...
   * [Add Items](https://docs.vikrai.com/api/admin#claims_postclaimsidclaimitems) API route.
   * 
   ...
   * sends a request to the [Update Claim Item](https://docs.vikrai.com/api/admin#claims_postclaimsidclaimitemsaction_id) API route.
   * 
   ...
   * It sends a request to the [Remove Claim Item](https://docs.vikrai.com/api/admin#claims_deleteclaimsidclaimitemsaction_id)
   * API route.
   * 
   * Every item has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * 
   * This method sends a request to the [Add Inbound Items](https://docs.vikrai.com/api/admin#claims_postclaimsidinbounditems)
   * API route.
   * 
   ...
   * It sends a request to the [Update Inbound Item](https://docs.vikrai.com/api/admin#claims_postclaimsidinbounditemsaction_id)
   * API route.
   * 
   * Every item has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * It sends a request to the [Remove Inbound Item](https://docs.vikrai.com/api/admin#claims_deleteclaimsidinbounditemsaction_id)
   * API route.
   * 
   * Every item has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * 
   * This method sends a request to the [Add Inbound Shipping](https://docs.vikrai.com/api/admin#claims_postclaimsidinboundshippingmethod)
   * API route.
   * 
   * @param id - The claim's ID.
   ...
   * It sends a request to the [Update Inbound Shipping](https://docs.vikrai.com/api/admin#claims_postclaimsidinboundshippingmethodaction_id)
   * API route.
   * 
   ...
   * It sends a request to the [Remove Inbound Shipping](https://docs.vikrai.com/api/admin#claims_deleteclaimsidinboundshippingmethodaction_id)
   * API route.
   * 
   * Every shipping method has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * It sends a request to the [Add Outbound Items](https://docs.vikrai.com/api/admin#claims_postclaimsidoutbounditems)
   * API route.
   * 
   ...
   * It sends a request to the [Update Outbound Item](https://docs.vikrai.com/api/admin#claims_postclaimsidoutbounditemsaction_id)
   * API route.
   * 
   * Every item has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * It sends a request to the [Remove Outbound Item](https://docs.vikrai.com/api/admin#claims_deleteclaimsidoutbounditemsaction_id)
   * API route.
   * 
   * Every item has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * [Add Outbound Shipping](https://docs.vikrai.com/api/admin#claims_postclaimsidoutboundshippingmethod)
   * API route.
   * 
   * @param id - The claim's ID.
   * @param body - The shipping method's details.
   ...
   * It sends a request to the [Update Outbound Shipping](https://docs.vikrai.com/api/admin#claims_postclaimsidoutboundshippingmethodaction_id)
   * API route.
   * 
   * Every shipping method has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * It sends a request to the [Confirm Claim Request](https://docs.vikrai.com/api/admin#claims_postclaimsidrequest)
   * API route.
   * 
   * @param id - The claim's ID.
   ...
   * [Cancel Claim Request](https://docs.vikrai.com/api/admin#claims_deleteclaimsidrequest)
   * API route.
   * 
   * @param id - The claim's ID.
   * @param query - Configure the fields to retrieve in the claim.
