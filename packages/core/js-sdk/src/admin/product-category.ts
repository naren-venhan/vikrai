...
export class ProductCategory {
   ...
   * [Create Category](https://docs.vikrai.com/api/admin#product-categories_postproductcategories)
   * API route.
   * 
   ...
   * [Update Category](https://docs.vikrai.com/api/admin#product-categories_postproductcategoriesid)
   * API route.
   * 
   ...
   * [List Product Categories](https://docs.vikrai.com/api/admin#product-categories_getproductcategories) API route.
   * 
   ...
   * [Get Product Category](https://docs.vikrai.com/api/admin#product-categories_getproductcategoriesid) API route.
   * 
   ...
   * [Delete Product Category](https://docs.vikrai.com/api/admin#product-categories_deleteproductcategoriesid)
   * API route.
   * 
   * @param id - The category's ID.
   * @param headers - Headers to pass in the request
   ...
   * to the [Manage Products](https://docs.vikrai.com/api/admin#product-categories_postproductcategoriesidproducts)
   * API route.
   * 
   * @param id - The category's ID.
