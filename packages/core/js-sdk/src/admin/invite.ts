...
export class Invite {
   ...
   * (https://docs.vikrai.com/api/admin#invites_postinvitesaccept)
   * API route.
   * 
   ...
   * [Create Invite](https://docs.vikrai.com/api/admin#invites_postinvites)
   * API route.
   * 
   ...
   * [Get Invite](https://docs.vikrai.com/api/admin#invites_getinvitesid)
   * API route.
   * 
   ...
   * [List Invites](https://docs.vikrai.com/api/admin#invites_getinvites)
   * API route.
   * 
   ...
   * [Refresh Invite Token](https://docs.vikrai.com/api/admin#invites_postinvitesidresend)
   * API route.
   * 
   * @param id - The invite's ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Delete Invite](https://docs.vikrai.com/api/admin#invites_deleteinvitesid)
   * API route.
   * 
   * @param id - The invite's ID.
   * @param headers - Headers to pass in the request.
