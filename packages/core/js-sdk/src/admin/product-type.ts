...
export class ProductType {
   ...
   * [Create Product Type](https://docs.vikrai.com/api/admin#product-types_postproducttypes)
   * API route.
   * 
   ...
   * [Update Product Type](https://docs.vikrai.com/api/admin#product-types_postproducttypesid)
   * API route.
   * 
   ...
   * [List Product Types](https://docs.vikrai.com/api/admin#product-types_getproducttypes) API route.
   * 
   ...
   * [Get Product Type](https://docs.vikrai.com/api/admin#product-types_getproducttypesid)
   * API route.
   * 
   * @param id - The product type's ID.
   * @param query - Configure the fields to retrieve in the product type.
   ...
   * [Delete Product Type](https://docs.vikrai.com/api/admin#product-types_deleteproducttypesid)
   * API route.
   * 
   * @param id - The product type's ID.
   * @param headers - Headers to pass in the request
