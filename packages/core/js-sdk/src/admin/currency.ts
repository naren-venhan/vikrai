...
export class Currency {
   ...
   * [List Currencies](https://docs.vikrai.com/api/admin#currencies_getcurrencies)
   * API route.
   * 
   ...
   * [Get Currency](https://docs.vikrai.com/api/admin#currencies_getcurrenciescode) API route.
   * 
