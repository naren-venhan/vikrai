...
export class PaymentCollection {
   ...
   * [Create Payment Collection](https://docs.vikrai.com/api/admin#payment-collections_postpaymentcollections)
   * API route.
   * 
   ...
   * [Delete Payment Collection](https://docs.vikrai.com/api/admin#payment-collections_deletepaymentcollectionsid)
   * API route.
   * 
   ...
   * [Mark as Paid](https://docs.vikrai.com/api/admin#payment-collections_postpaymentcollectionsidmarkaspaid)
   * API route.
   * 
