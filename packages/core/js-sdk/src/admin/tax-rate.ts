...
export class TaxRate {
   ...
   * [Create Tax Rate](https://docs.vikrai.com/api/admin#tax-rates_posttaxrates)
   * API route.
   *
   ...
   * [Update Tax Rate](https://docs.vikrai.com/api/admin#tax-rates_posttaxratesid)
   * API route.
   *
   ...
   * [Delete Tax Rate](https://docs.vikrai.com/api/admin#tax-rates_deletetaxratesid)
   * API route.
   *
   ...
   * [Get Tax Rate](https://docs.vikrai.com/api/admin#tax-rates_gettaxratesid)
   * API route.
   *
   ...
   * [List Tax Rates](https://docs.vikrai.com/api/admin#tax-rates_gettaxrates)
   * API route.
   *
