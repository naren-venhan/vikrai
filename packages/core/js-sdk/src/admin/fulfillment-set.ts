...
export class FulfillmentSet {
   ...
   * [Delete Fulfillment Set](https://docs.vikrai.com/api/admin#fulfillment-sets_deletefulfillmentsetsid)
   * API route.
   * 
   ...
   * [Add Service Zone](https://docs.vikrai.com/api/admin#fulfillment-sets_postfulfillmentsetsidservicezones)
   * API route.
   * 
   * @param id - The fulfillment set's ID.
   ...
   * [Get Service Zone](https://docs.vikrai.com/api/admin#fulfillment-sets_getfulfillmentsetsidservicezoneszone_id)
   * API route.
   * 
   ...
   * [Update Service Zone](https://docs.vikrai.com/api/admin#fulfillment-sets_postfulfillmentsetsidservicezoneszone_id)
   * API route.
   * 
   * @param fulfillmentSetId - The fulfillment set's ID.
   * @param serviceZoneId - The service zone's ID.
   ...
   * [Remove Service Zone](https://docs.vikrai.com/api/admin#fulfillment-sets_deletefulfillmentsetsidservicezoneszone_id)
   * API route.
   * 
