...
export function vikraiInternalService<
  TContainer extends object = object,
  TEntity extends object = any
>(
  rawModel: any
): {
  new (container: TContainer): ModulesSdkTypes.IvikraiInternalService<
    TEntity,
    TContainer
  >
} {
  ...
  class AbstractService_
    implements ModulesSdkTypes.IvikraiInternalService<TEntity, TContainer>
  {
