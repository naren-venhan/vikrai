...
import { vikraiService } from "../vikrai-service"
import { InferTypeOf } from "@vikrai/types"
...
describe("vikrai Service typings", () => {
  describe("create<Service>", () => {
    test("type-hint model properties", () => {
      class BlogService extends vikraiService({ Blog, Comment }) {}
    ...
    test("type-hint DTO properties", () => {
      class BlogService extends vikraiService<{ Blog: { dto: BlogDTO } }>({
        Blog,
      }) {}
      const blogService = new BlogService(containerMock)
    ...
    test("define custom DTO for inputs", () => {
      class BlogService extends vikraiService<{
  ...
  describe("update<Service>", () => {
    test("type-hint model properties", () => {
      class BlogService extends vikraiService({ Blog }) {}
      const blogService = new BlogService(containerMock)
